...
namespace CodeAnalysis
{
    ...
    public class Parser
    {
        ...
        //Default constryctor used to initialise the data members
        public Parser()
        {
            Rules = new List<IRule>();
        }
        //Function used to add various rules which are used for finding type relationships and function complexity
    ...
    class TestParser
    {
        ...
        //Displays the list of input arguments

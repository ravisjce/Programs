...
namespace CSsemi
{
    ...
    public class CSemiExp
    {
        ...
        //Find the total number of occurences of str in semi-expression
        ...
        /*This method returns the name of the variable and its type name in the semi expression
                * This is required for finding the list of variables which are either struct or enum
                * Fot ex: If the semi expression is "public static st t1;" where st is of type struct
                * then the list will contains st,t1 as its elements 
               */
      ...
      { 
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                while (test.getSemi())  test.display();
            test.initialize();
            test.insert(0, "this");
            test.insert(1, "is");          
            test.display();
            ...
            test.display();           
                ...
                while (semi.getSemi())  semi.display();
                semi.close();
                Console.ReadLine();
            }
            catch
